...
provides a simple calculator for establishing the most appropriate snowboard size for you. 
...
The application contains also a tab with an interactive chart displaying statistics about :
